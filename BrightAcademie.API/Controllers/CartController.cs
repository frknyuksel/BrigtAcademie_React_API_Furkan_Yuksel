...
using BrightAcademie.Shared.ControllerBases;
...
namespace CoursesApp.MVC.Controllers
{
    ...
    public class CartController : CustomControllerBase
    {
        ...
        public CartController(BrightAcademieContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> GetCheckoutData()
        {
            ...
            // OrderDto, CartDto ve CartItemDto kullanarak veriyi doldurun
            ...
            // OrderDto ve CartDto'yu kullanarak JSON yanıtını oluşturun
            var response = new
            {
                Order = orderDto,
                Cart = cartDto,
        ...
        private async Task SaveOrder(OrderDto model, string userId)
        {
            ...
            order.OrderItems = new List<BrightAcademie.Entity.Concrete.OrderItem>();
            BrightAcademie.Entity.Concrete.OrderItem orderItem;
            foreach (var item in model.Cart.CartItems)
            {
                orderItem = new BrightAcademie.Entity.Concrete.OrderItem();
